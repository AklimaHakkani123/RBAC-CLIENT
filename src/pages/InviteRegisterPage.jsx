  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-10 sm:py-14">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -left-20 top-6 h-56 w-56 rounded-full bg-violet-300/30 blur-3xl" />
        <div className="absolute right-0 top-20 h-72 w-72 rounded-full bg-cyan-300/25 blur-3xl" />
      </div>

      <div className="mx-auto w-full max-w-md rounded-2xl border border-white/70 bg-white/80 p-6 shadow-xl shadow-indigo-200/35 backdrop-blur sm:p-8">
