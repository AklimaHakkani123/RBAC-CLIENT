...
export default function UserRow({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-indigo-100/90 bg-white/85 p-4 shadow-sm shadow-indigo-100/50 lg:flex-row lg:items-center lg:justify-between">
      <div>
